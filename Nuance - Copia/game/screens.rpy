...
## ========================================================================== ##
## TELA DE ESCOLHAS UNIFICADA (choice + middle_choice_screen)
## ========================================================================== ##

## Transform de animação de hover
...
## Estilo da janela de escolhas (sem fundo preto)
...
style choice_button is textbutton:
    background Frame(Solid("#B78AE0"), 30, 30)          # cor lilás
    hover_background Frame(Solid("#FF69B4"), 30, 30)    # cor rosa ao passar mouse
    xmaximum 900
    ymaximum None
    ypadding 20
    xpadding 40
...
## =========================================================
## SCREEN padrão de escolhas (sobrescreve choice())
## =========================================================
screen choice(items):
    frame:
        background None
...
## =========================================================
## SCREEN de escolhas centralizadas (middle_choice_screen)
## =========================================================
    ...
    window:
        ...
        vbox:
            ...
            for i, choice in enumerate(choices):
                textbutton choice action Return(i) style "choice_button" at choice_anim
