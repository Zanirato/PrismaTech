...
screen main_menu():
    ...
    add "images/player.png" xalign 0.9 yalign 0.3 zoom 8.0
    
    # Personagem à direita
    add "images/lucas.png" xalign 2 yalign 0.3 zoom 8.0


    # Logo
    add "images/logo.png" xalign 0.5 yalign 0.0 zoom 0.5
    ...
    vbox:
        ...
        textbutton "Iniciar" action Start() style "menu_button"
